    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h2 className="text-4xl font-black tracking-tight text-on-surface mb-3">
                        Danh sách nhà cung cấp
                    </h2>
                    <p className="text-on-surface-variant text-base max-w-lg">
                        Quản lý thông tin và tình trạng hợp tác với các đối tác
                        cung ứng.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
                <div className="bg-surface-container-lowest p-6 rounded-xl shadow-sm border border-outline-variant/10 border-l-4 border-l-primary relative overflow-hidden group hover:shadow-md transition-shadow duration-300">
                    ...
                    <div className="flex items-end justify-between">
                        ...
                        <span className="text-sm font-bold text-primary bg-primary-fixed px-3 py-1 rounded-md">
                            +12%
                        </span>
                    </div>
                </div>
                <div className="bg-surface-container-lowest p-6 rounded-xl shadow-sm border border-outline-variant/10 border-l-4 border-l-secondary-container relative overflow-hidden group hover:shadow-md transition-shadow duration-300">
                    ...
                    <div className="flex items-end justify-between">
                        ...
                        <span className="text-sm font-bold text-secondary text-on-secondary-container bg-secondary-container px-3 py-1 rounded-md">
                            95%
                        </span>
                    </div>
                </div>
                <div className="bg-surface-container-lowest p-6 rounded-xl shadow-sm border border-outline-variant/10 border-l-4 border-l-tertiary-container relative overflow-hidden group hover:shadow-md transition-shadow duration-300">
                    ...
                    <div className="flex items-end justify-between">
                        ...
                        <span className="text-sm font-bold text-tertiary bg-tertiary-fixed px-3 py-1 rounded-md">
                            Cần xử lý
                        </span>
                    </div>
                </div>
            ...
            <div className="bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/10 overflow-hidden flex flex-col">
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-outline-variant/10">
                            ...
                            <tr className="hover:bg-surface-container-low/40 transition-colors group">
                                <td className="px-6 py-6">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 rounded-lg bg-surface-container-high flex items-center justify-center font-bold text-lg text-primary">
                                            KA
                                        </div>
                                        <div>
                                ...
                                <td className="px-6 py-6 text-base font-medium text-slate-700">
                                    Lê Minh Tuấn
                                </td>
                                <td className="px-6 py-6 text-base text-slate-600 font-mono">
                                    090 123 4567
                                </td>
                                <td className="px-6 py-6 text-base text-primary hover:underline cursor-pointer">
                                    tuan.lm@kinetic.com
                                </td>
                                <td className="px-6 py-6 text-base text-slate-600 max-w-[200px] truncate">
                                    123 Đường Công Nghệ, Q.9, TP. HCM
                                </td>
                                <td className="px-6 py-6">
                            ...
                            <tr className="hover:bg-surface-container-low/40 transition-colors group">
                                ...
                                <td className="px-6 py-6 text-base text-primary hover:underline cursor-pointer">
                                    hong.nt@globallog.vn
                                </td>
                                <td className="px-6 py-6 text-base text-slate-600 max-w-[200px] truncate">
                                    45 Cảng Cát Lái, Q.2, TP. HCM
                                </td>
                                <td className="px-6 py-6">
                                    <span className="whitespace-nowrap inline-flex px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-wider bg-secondary-container/40 text-on-secondary-container">
                                        Đang hợp tác
                ...
                <div className="p-6 md:p-8 flex items-center justify-between border-t border-outline-variant/10 bg-surface-container-lowest mt-auto">
                    <p className="text-sm text-slate-500 font-medium">
                        Hiển thị{" "}
                        <span className="text-slate-900 font-bold">1-3</span>{" "}
                        trong tổng số{" "}
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            className="w-10 h-10 rounded-lg flex items-center justify-center text-slate-400 hover:bg-surface-container-low transition-all disabled:opacity-30"
                            disabled
                        >
                            <span className="material-symbols-outlined text-lg">
                                chevron_left
                        ...
                        <button className="w-10 h-10 rounded-lg flex items-center justify-center bg-primary text-white text-sm font-bold shadow-md shadow-primary/20">
                            1
                        </button>
                        <button className="w-10 h-10 rounded-lg flex items-center justify-center text-slate-600 hover:bg-surface-container-low text-sm font-bold transition-all">
                            2
                        </button>
                        <button className="w-10 h-10 rounded-lg flex items-center justify-center text-slate-600 hover:bg-surface-container-low text-sm font-bold transition-all">
                            3
