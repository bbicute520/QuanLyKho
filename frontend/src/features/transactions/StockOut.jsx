...
export default function StockOut() {
  return (
    <div className="max-w-7xl mx-auto">
      {/* Header Section */}
      <div className="mb-10">
        <h2 className="text-4xl font-black tracking-tight text-on-surface mb-3">Tạo phiếu xuất kho</h2>
        <p className="text-on-surface-variant text-base max-w-lg">Khởi tạo quy trình xuất hàng đi. Đảm bảo tất cả thông tin SKU và số lượng đã được đối soát chính xác.</p>
      </div>
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 lg:col-span-4 flex flex-col gap-6">
          ...
          <section className="bg-surface-container-lowest p-8 rounded-xl shadow-sm border border-outline-variant/10 relative overflow-hidden">
            ...
            <div className="space-y-6">
              <div className="space-y-2.5">
                ...
                <Input id="ma-xuat" defaultValue="OUT-2023-8842" readOnly className="bg-surface-container-low border-outline-variant/30 focus-visible:ring-primary font-mono text-base h-12 shadow-sm" />
              </div>
              <div className="space-y-2.5">
                <Label htmlFor="khach-hang" className="text-xs font-bold uppercase tracking-wider text-outline">Khách hàng / Dự án</Label>
                <div className="relative">
                  <Input id="khach-hang" placeholder="Chọn đối tác..." className="bg-surface-container-low border-outline-variant/30 focus-visible:ring-primary text-base h-12 shadow-sm pr-10" />
              ...
              <div className="space-y-2.5">
                ...
                <Input id="ngay-xuat" type="date" className="bg-surface-container-low border-outline-variant/30 focus-visible:ring-primary text-base h-12 shadow-sm block" />
              </div>
              <div className="space-y-2.5">
                <Label htmlFor="ly-do" className="text-xs font-bold uppercase tracking-wider text-outline">Lý do xuất</Label>
                <textarea id="ly-do" className="flex w-full rounded-md border border-outline-variant/30 bg-surface-container-low px-4 py-3 text-base shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary resize-none" placeholder="Ghi chú lý do xuất hàng..." rows="4"></textarea>
              </div>
            </div>
          </section>
          ...
          <div className="bg-primary text-white p-8 rounded-xl shadow-lg relative overflow-hidden flex-1">
            ...
            <h4 className="text-5xl font-black mb-6">0 <span className="text-xl font-medium opacity-60">SKUs</span></h4>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-outline-variant/10">
                  <tr className="hover:bg-surface-container-low/40 transition-colors">
                    <td className="px-8 py-6 font-mono text-sm font-bold text-primary">SKU-9021-X</td>
                    <td className="px-8 py-6">
                      <p className="text-base font-bold text-slate-900 mb-1">Precision Sensor Node v4</p>
                      <p className="text-xs text-slate-400 uppercase">Hardware / Electronics</p>
                    </td>
                    <td className="px-8 py-6 text-right"><span className="text-base font-medium text-slate-600">1,240</span></td>
                    <td className="px-8 py-6 text-center">
                      <Input type="number" defaultValue="0" min="0" className="w-24 h-10 mx-auto text-center bg-surface-container-low border-outline-variant/30 focus-visible:ring-primary font-bold text-base shadow-sm" />
                    </td>
